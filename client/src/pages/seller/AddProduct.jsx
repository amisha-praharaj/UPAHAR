    ...
    return (
        <div className=" no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <form onSubmit={onsubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                        ...
                        {Array(4).fill('').map((_, index) => (
                            <label key={index} htmlFor={`image${index}`}>
                                ...
                                {files[index] ? (
                                    ...
                                    <div className="w-[60px] h-[40px] flex items-center justify-center bg-gray-100 rounded cursor-pointer">
                ...
                <button type="submit" className="px-8 py-2.5 bg-primary-dull hover:bg-primary text-white font-medium rounded cursor-pointer">
                    ADD
                </button>
            </form>
        </div>
